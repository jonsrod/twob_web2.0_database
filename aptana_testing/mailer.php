...
$AddressToEmailTo = "jonsrod1992@gmail.com";

$SubjectOfEmail = "Instrument traveler has been created, and sent to manufacturing. The instrument model number is <?php echo $Model $idSerialNumber ?> -- should go here";
